...
import type {PreparedExportProposal} from '../../src/integration/export-adapters.mjs';
declare const proposal:PreparedExportProposal;
const prepared:Awaited<ReturnType<ExportAdapter['export']>>=proposal;
// @ts-expect-error No bytes before explicit confirmation.
const premature:Uint8Array=proposal.bytes;
// @ts-expect-error Confirmation identity is immutable.
proposal.proposalHash='0'.repeat(64);
void [prepared,premature];
