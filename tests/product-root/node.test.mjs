...
import {M,client,operation,dispatcher,setLive,noOwned,transportLog,recordFramedNativeSource,forgetNativeSource,manufacturingPreview} from '../product-app/harness.mjs';
