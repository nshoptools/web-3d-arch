// Generated from the original harfbuzzjs 1.6.1 wrapper. Do not edit by hand.
...
function utf8_ptr_to_string(ptr, length) {
	...
	return utf8Decoder.decode(new Uint8Array(Module.HEAPU8.subarray(ptr, end)));
}
...
//#endregion
//#region src/index.ts
/** Bind once to the same Emscripten instance that owns geometry and its heap. */
